...
(function () {
  ...
  ProductHaus.util = ProductHaus.util || {};
  ...
  ProductHaus.util.sortAlpha = function (options) {
  ...
  ProductHaus.util.makeField = function (value, options, extra) {
  ...
  ProductHaus.util.makeGroupedField = function (value, optionGroups, extra) {
    var flatOptions = [];
  ...
  // over several clicks.
  ProductHaus.util.randomizeGroupWithCap = function (entries, cap, applyFn, clearFn) {
  ...
  ProductHaus.util.createStore = function (initialState) {
  ...
  ProductHaus.util.updateField = function (store, fieldName, changes) {
