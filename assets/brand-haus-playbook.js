 ...
 *
 * 20 chapters across 5 Parts. Every chapter ends with two shared closers,
...
(function () {
  ...
  // adds only the "Why You Matched" line, which lives in results.js's
  // Chapter 5 bundled with Strengths/Blind Spots that belong to this
  // Playbook's own Chapter 9 instead, so it's rebuilt here standalone.
  // ---------------------------------------------------------------------
  function renderChapter2(ui, results) {
    ...
    return ui.el("div", {}, [
      ...
      ui.el("section", { class: "bh-chapter" }, [
        ui.el("p", { class: "bh-chapter__section-title" }, [
          ui.el("span", { text: "Why You Matched" }),
          ui.el("span", { class: "bh-chapter__number-badge", text: "Guide 2 of 20" }),
        ]),
        ui.el("p", { class: "bh-chapter__foundation-line", text: whyMatched }),
        renderWhyThisMatters(ui, "Your Primary Brand Identity isn't a personality quiz result — it's the closest match to the patterns in your actual answers. The Alignment Score tells you how confidently, and the Supporting Influences show you what else is shaping your brand alongside it."),
        renderTakeAction(ui, [
  ...
  // ---------------------------------------------------------------------
  // Part I, Chapter 3 — Understanding Your Brand Psychology™
  ...
  function renderChapter3(ui, results) {
    ...
    return ui.el("section", { class: "bh-chapter" }, [
      r.chapterHeading(ui, "layers", "Understanding Your Brand Psychology™", null, null, "Guide 3 of 20"),
  ...
  function renderChapter4(ui, results) {
    ...
    return ui.el("section", { class: "bh-chapter" }, [
      r.chapterHeading(ui, "layers", "Your Founder DNA™", null, null, "Guide 4 of 20"),
      ui.el("p", { class: "bh-chapter__foundation-line", text: "Your Founder DNA groups 12 individual motivations into 4 human-readable clusters — this is what drives you, ranked from strongest to quietest." }),
    ].concat(sections).concat([
      renderWhyThisMatters(ui, "Your strongest cluster isn't just a personality trait — it's the lens you'll keep making decisions through, whether or not you notice you're doing it. Naming it means you can use it on purpose."),
      renderTakeAction(ui, [
  ...
  function renderChapter5(ui, results) {
    ...
    var children = [
      r.chapterHeading(ui, "sparkle", "The Story Hidden In Your Answers™", null, null, "Guide 5 of 20"),
    ];
  ...
  function renderChapter6(ui, results) {
    ...
    return ui.el("section", { class: "bh-chapter" }, [
      r.chapterHeading(ui, "sparkle", "How Your Brand Naturally Expresses Itself", null, null, "Guide 6 of 20"),
  ...
  function renderChapter7(ui, results) {
    ...
    return ui.el("section", { class: "bh-chapter" }, [
      r.chapterHeading(ui, "palette", "Your Visual Identity System™", null, null, "Guide 7 of 20"),
      ...
      renderWhyThisMatters(ui, "A visual identity system isn't a mood board — it's a set of rules that let anyone (you, a designer, an AI tool) make something new that still looks unmistakably like your brand."),
      renderTakeAction(ui, [
  ...
  function renderChapter8(ui, results) {
    ...
    return ui.el("section", { class: "bh-chapter" }, [
      r.chapterHeading(ui, "logoMark", "Your Brand Foundation™", null, null, "Guide 8 of 20"),
      ...
      renderWhyThisMatters(ui, "Your Mission, North Star, Promise, and Values aren't marketing copy — they're the decision filters that keep your brand consistent long after you've forgotten the exact wording."),
      renderTakeAction(ui, [
  ...
  function renderChapter9(ui, results) {
    ...
    return ui.el("section", { class: "bh-chapter" }, [
      r.chapterHeading(ui, "person", "Understanding Yourself", null, null, "Guide 9 of 20"),
      ...
      renderWhyThisMatters(ui, "Your brand isn't separate from you — especially at this stage, the two are the same thing. Knowing your own patterns is how you scale the business without losing what made it work in the first place."),
      renderTakeAction(ui, [
  ...
  function renderChapter10(ui, results) {
    ...
    return ui.el("section", { class: "bh-chapter" }, [
      r.chapterHeading(ui, "people", "Your Ideal Customer™", null, null, "Guide 10 of 20"),
  ...
  function renderChapter11(ui, results) {
    ...
    return ui.el("section", { class: "bh-chapter" }, [
      r.chapterHeading(ui, "heart", "How Customers Experience Your Brand™", null, null, "Guide 11 of 20"),
  ...
  function renderChapter13(ui, results) {
    ...
    if (!bia) {
      return ui.el("section", { class: "bh-chapter" }, [r.chapterHeading(ui, "person", "Your Brand In Action™", null, null, "Guide 13 of 20"), ui.el("p", { class: "bh-chapter__foundation-line", text: "Coming soon." })]);
    }

    return ui.el("section", { class: "bh-chapter" }, [
      r.chapterHeading(ui, "person", "Your Brand In Action™", null, null, "Guide 13 of 20"),
  ...
  function renderChapter14(ui) {
    ...
    return ui.el("section", { class: "bh-chapter" }, [
      r.chapterHeading(ui, "logoMark", "Creative Direction™", null, null, "Guide 14 of 20"),
      ...
      renderWhyThisMatters(ui, "Good creative direction isn't about talent — it's about consistency. A founder who applies these principles patiently will out-brand a more \"talented\" one who applies them randomly."),
      renderTakeAction(ui, [
  ...
  function renderChapter16(ui, results) {
    ...
    if (!dg) {
      return ui.el("section", { class: "bh-chapter" }, [r.chapterHeading(ui, "shield", "Decision Guide™", null, null, "Guide 16 of 20"), ui.el("p", { class: "bh-chapter__foundation-line", text: "Coming soon." })]);
    }

    return ui.el("section", { class: "bh-chapter" }, [
      r.chapterHeading(ui, "shield", "Decision Guide™", null, null, "Guide 16 of 20"),
  ...
  function renderChapter17(ui, results) {
    ...
    return ui.el("section", { class: "bh-chapter" }, [
      r.chapterHeading(ui, "refresh", "Brand Evolution™", null, null, "Guide 17 of 20"),
  ...
  function renderChapter18(ui, results) {
    ...
    return ui.el("section", { class: "bh-chapter" }, [
      r.chapterHeading(ui, "eye", "Your Brand Decision Filter™", null, null, "Guide 18 of 20"),
  ...
  function renderChapter19(ui, results) {
    ...
    return ui.el("section", { class: "bh-chapter" }, [
      r.chapterHeading(ui, "document", "Your Brand Constitution™", null, null, "Guide 19 of 20"),
  ...
  function renderChapter20(ui, results) {
    ...
    return ui.el("section", { class: "bh-chapter" }, [
      r.chapterHeading(ui, "lightning", "Next Steps", null, null, "Guide 20 of 20"),
      ...
      ui.el("p", { class: "bh-chapter__highlight-line", text: "Every color, font, and word in this Playbook is already loaded into Branding Studio and Logo Studio — that's where it turns into real, usable assets." }),
      continueBtn,
      ui.el("p", { class: "bh-chapter__section-title", text: "Explore The Rest Of Black Sheep" }),
      ui.el("p", { class: "bh-chapter__foundation-line", text: "Your Brand DNA feeds directly into the other Haus tools — the same identity, applied to marketing, content, and creative direction." }),
      ...
      ui.el("p", { class: "bh-chapter__foundation-line", text: "This Playbook isn't meant to be read once. Export it, save it, and come back to specific guides whenever you're making a real decision about your brand." }),
      renderWhyThisMatters(ui, "A Brand Playbook that sits unread does nothing. One that gets opened before the next big decision is worth every question it took to build."),
      renderTakeAction(ui, [
  ...
  // ---------------------------------------------------------------------
  // renderFull — assembles all 5 Parts / 20 chapters into one document
  // ---------------------------------------------------------------------
  // Single source of truth for both the rendered chapter order AND the
  // table of contents below — the numbers deliberately skip 12 and 15
  // (Competitive Edge and Business Strategy, cut during scoping since
  // both would require assuming what the founder's business sells).
  function playbookParts(ui, effectiveResults) {
    return [
      { roman: "I", title: "Understanding Your Brand", subtitle: "What the assessment discovered", chapters: [
        ...
        { id: "ch3", num: 3, title: "Understanding Your Brand Psychology™", render: function () { return renderChapter3(ui, effectiveResults); } },
        { id: "ch4", num: 4, title: "Your Founder DNA™", render: function () { return renderChapter4(ui, effectiveResults); } },
        { id: "ch5", num: 5, title: "The Story Hidden In Your Answers™", render: function () { return renderChapter5(ui, effectiveResults); } },
      ] },
      { roman: "II", title: "Building Your Brand", subtitle: "Turning identity into design", chapters: [
        { id: "ch6", num: 6, title: "How Your Brand Naturally Expresses Itself", render: function () { return renderChapter6(ui, effectiveResults); } },
        { id: "ch7", num: 7, title: "Your Visual Identity System™", render: function () { return renderChapter7(ui, effectiveResults); } },
        { id: "ch8", num: 8, title: "Your Brand Foundation™", render: function () { return renderChapter8(ui, effectiveResults); } },
      ] },
      { roman: "III", title: "Bringing Your Brand To Life", subtitle: "This is where it becomes a Playbook", chapters: [
        { id: "ch9", num: 9, title: "Understanding Yourself", render: function () { return renderChapter9(ui, effectiveResults); } },
        { id: "ch10", num: 10, title: "Your Ideal Customer™", render: function () { return renderChapter10(ui, effectiveResults); } },
        { id: "ch11", num: 11, title: "How Customers Experience Your Brand™", render: function () { return renderChapter11(ui, effectiveResults); } },
      ] },
      { roman: "IV", title: "Operating Your Brand", subtitle: "The business manual", chapters: [
        { id: "ch13", num: 13, title: "Your Brand In Action™", render: function () { return renderChapter13(ui, effectiveResults); } },
        { id: "ch14", num: 14, title: "Creative Direction™", render: function () { return renderChapter14(ui); } },
        { id: "ch16", num: 16, title: "Decision Guide™", render: function () { return renderChapter16(ui, effectiveResults); } },
      ] },
      { roman: "V", title: "Long-Term Growth", subtitle: null, chapters: [
        { id: "ch17", num: 17, title: "Brand Evolution™", render: function () { return renderChapter17(ui, effectiveResults); } },
        { id: "ch18", num: 18, title: "Your Brand Decision Filter™", render: function () { return renderChapter18(ui, effectiveResults); } },
        { id: "ch19", num: 19, title: "Your Brand Constitution™", render: function () { return renderChapter19(ui, effectiveResults); } },
        { id: "ch20", num: 20, title: "Next Steps", render: function () { return renderChapter20(ui, effectiveResults); } },
      ] },
    ];
  }
  ...
  function renderFull(ui, effectiveResults) {
    ...
    exportBtn.addEventListener("click", function () {
      BrandHaus.ui.printStyledSection(content, BrandHaus.results.accentStyleFor(profile), "Your Brand Playbook™ — Black Sheep Creations", profile, "epic");
    });
