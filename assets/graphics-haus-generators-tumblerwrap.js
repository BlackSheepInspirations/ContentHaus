/**
 * The AI Creator's Graphics Haus — Tumbler / Product Wrap Generator
 ...
 * bottles. Ported from the Project Haus generator of the same name so
 * both tools share it. The critical constraint is SEAM ALIGNMENT: the
 * left and right edges of the flat artwork physically meet when wrapped
 * around the cup, so they must line up seamlessly. Per-product template
 * dimensions are injected so the aspect and safe area are correct.
 */
(function () {
  "use strict";
