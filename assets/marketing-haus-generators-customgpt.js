...
(function () {
  ...
  MarketingHaus.generatorEngine.registerGenerator({
    ...
    basePromptTemplate:
      ...
      "Return, clearly labeled: a Name, a one-line Description, full System Instructions (its role, how it should respond, and its limits{scopeClause}), and 4 Conversation Starters.",
    charmPromptTemplate:
      ...
      "Give it a memorable Name, a warm one-line Description, thorough System Instructions (role, response style, limits{scopeClause}), and 4 inviting Conversation Starters.",
    dynamicPromptTemplate:
      ...
      "Give it a strong Name, a punchy Description, precise System Instructions (role, response rules, limits{scopeClause}), and 4 high-intent Conversation Starters.",
    charmPool: [
