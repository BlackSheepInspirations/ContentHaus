/**
 * The AI Creator's Marketing Haus — shared store/field utilities
 * Loaded first. Establishes window.MarketingHaus and the tiny store/field
 * utilities that every other marketing-haus-*.js module reuses.
 *
...
(function () {
  ...
  MarketingHaus.util = MarketingHaus.util || {};
  ...
  MarketingHaus.util.sortAlpha = function (options) {
  ...
  MarketingHaus.util.makeField = function (value, options, extra) {
  ...
  MarketingHaus.util.makeGroupedField = function (value, optionGroups, extra) {
    var flatOptions = [];
  ...
  // over several clicks.
  MarketingHaus.util.randomizeGroupWithCap = function (entries, cap, applyFn, clearFn) {
  ...
  MarketingHaus.util.createStore = function (initialState) {
  ...
  MarketingHaus.util.updateField = function (store, fieldName, changes) {
