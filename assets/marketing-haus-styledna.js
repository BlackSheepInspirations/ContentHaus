/**
 * The AI Creator's Marketing Haus — Business/Voice DNA (shared state)
 * Depends on marketing-haus-util.js (must load first).
 *
...
(function () {
  ...
  // Ratio auto-follows Project Type, since Marketing Haus generators
  ...
  var store = MarketingHaus.util.createStore({
    ...
    holiday: MarketingHaus.util.makeGroupedField("", HOLIDAY_GROUPS),
  ...
  function setBusinessName(value) {
    MarketingHaus.util.updateField(store, "businessName", { value: value });
  }
  function setTone(value) {
    MarketingHaus.util.updateField(store, "tone", { value: value, customValue: "" });
  }
  function setAudience(value) {
    MarketingHaus.util.updateField(store, "audience", { value: value });
  }
  function setReadingLevel(value) {
    MarketingHaus.util.updateField(store, "readingLevel", { value: value, customValue: "" });
  }
  function setVariationCount(value) {
    MarketingHaus.util.updateField(store, "variationCount", { value: value, customValue: "" });
  }
  function setHoliday(value) {
    MarketingHaus.util.updateField(store, "holiday", { value: value, customValue: "" });
  }
  function setTheme(value) {
    MarketingHaus.util.updateField(store, "theme", { value: value, customValue: "" });
  }
  function setNiche(value) {
    MarketingHaus.util.updateField(store, "niche", { value: value, customValue: "" });
  }
  ...
  function setTargetPlatform(value) {
    MarketingHaus.util.updateField(store, "targetPlatform", { value: value, customValue: "" });
  }
  function setAspectRatio(value) {
    MarketingHaus.util.updateField(store, "aspectRatio", { value: value, customValue: "" });
  }
  ...
  function setOutputFormat(newValue) {
    MarketingHaus.util.updateField(store, "outputFormat", { value: newValue, customValue: "" });
  }
