...
(function () {
  ...
  function renderSection(root) {
    ...
    var headerChildren = [ui.el("h3", { class: "gh-saved__title" }, [ui.icon("palette"), ui.el("span", { text: "Look Lock (" + looks.length + "/" + MAX_LOOKS + ")" })])];
    if (looks.length > 1) {
      ...
      toggleBtn.addEventListener("click", function () { lookLockExpanded = !lookLockExpanded; GraphicsHaus.ui.renderApp(); });
