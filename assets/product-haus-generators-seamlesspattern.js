/**
 * The AI Creator's Project Haus — Seamless Pattern Generator
 ...
 * tile. Like the Sticker Sheet, this is a deliberate exception to the
 * "one subject per image" rule: the whole point is an all-over repeat.
 * The locked suffix leans hard on edge-continuity language (the left
 * edge must flow into the right, the top into the bottom) so the
 * receiving AI produces a true seamless tile with no visible seam.
 */
(function () {
  "use strict";
